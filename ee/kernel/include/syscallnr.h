...
#define __NR_ResetEE					0x01
#define __NR_SetGsCrt					0x02
#define __NR__Exit						0x04
#define __NR_ResumeIntrDispatch			0x05	//Arbitrarily named
#define __NR__LoadExecPS2				0x06
#define __NR__ExecPS2					0x07
#define __NR_ResumeT3IntrDispatch		0x08	//Arbitrarily named (used by alarm update)
#define __NR_RFU009						0x09
#define __NR_AddSbusIntcHandler			0x0a
#define __NR_RemoveSbusIntcHandler		0x0b
#define __NR_Interrupt2Iop				0x0c
#define __NR_SetVTLBRefillHandler		0x0d
#define __NR_SetVCommonHandler			0x0e
#define __NR_SetVInterruptHandler		0x0f
